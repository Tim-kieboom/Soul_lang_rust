...
pub fn parser<'a>(token_response: TokenizeResonse, sub_files: Option<Arc<SubFileTree>>, info: &RunStepsInfo<'a>, path: &PathBuf, file_name: &String) -> Result<ParserResponse> {

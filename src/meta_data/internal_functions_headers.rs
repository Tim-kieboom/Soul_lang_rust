...
use crate::{errors::soul_error::SoulSpan, steps::step_interfaces::i_parser::{abstract_syntax_tree::{expression::{ExprKind, Ident}, generics::{GenericKind, GenericParam}, literal::Literal, soul_type::{soul_type::SoulType, type_kind::{Modifier, TypeKind, TypeWrapper}}, spanned::Spanned, staments::{function::{FnDeclKind, FunctionSignatureRef, InnerFunctionSignature, Parameter}, objects::{FieldDecl, InnerStructDecl, StructDeclRef}}, visibility::{FieldAccess}}, external_header::Header, scope::{OverloadedFunctions, ScopeKind}}};
...
pub fn load_std_headers() -> io::Result<()> {
    ...
    let fmt_bin = bincode::serialize(&get_fmt_header())
